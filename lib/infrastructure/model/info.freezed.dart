...
abstract class $InfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CardItem> cardList});
}
...
class _$InfoImpl implements _Info {
  const _$InfoImpl({final List<CardItem> cardList = const []})
      : _cardList = cardList;
...
abstract class _Info implements Info {
  const factory _Info({final List<CardItem> cardList}) = _$InfoImpl;
